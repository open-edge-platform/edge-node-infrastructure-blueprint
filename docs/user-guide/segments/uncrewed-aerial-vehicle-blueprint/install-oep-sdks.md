...
- [DL Streamer Pipelines Guide](../../how-to/build-dlstreamer-pipelines.md) — pipeline reference and variants
- [Edge Workloads and Benchmarks Guide](../../how-to/run-edge-benchmarks.md) — reproducible benchmark suite
- [Container Device Interface Guide](../../how-to/configure-cdi.md) — CDI setup for GPU/NPU access from containers
